...
auto original(const std::array<Scalar, 3>& initial_input) { 
    ...
    relu<Scalar>(layer_1_output.data(), model_input.data(), 3, 0.0);

    std::array<Scalar, 3> layer_2_output;
    linear<Scalar>(layer_2_output.data(), layer_1_output.data(), 3, 0.0);
    ...
    sigmoid<Scalar>(layer_9_output.data(), layer_8_output.data(), 8, 0.0);

    std::array<Scalar, 8> layer_10_output;
    linear<Scalar>(layer_10_output.data(), layer_9_output.data(), 8, 0.0);

    std::array<Scalar, 8> layer_11_output;
    elu<Scalar>(layer_11_output.data(), layer_10_output.data(), 8, 0.0);
